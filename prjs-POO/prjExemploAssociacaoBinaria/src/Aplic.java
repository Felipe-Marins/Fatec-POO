...
public class Aplic {
    public static void main(String[] args) {
       ...
       //1 objeto da classe Departamento
        ...
        System.out.println("O funcionario " + funcHor.getNome() + " trabalha no departamento " 
       ...
       funcMen.setDepartamento(objDep1);
        System.out.println("O funcionario " + funcMen.getNome() + " trabalha no departamento " 
       ...
       funcCom.setDepartamento(objDep2);
        System.out.println("O funcionario " + funcCom.getNome() + " trabalha no departamento " 
       ...
       Projeto prj1 = new Projeto(001,"Projeto Compras");
       prj1.setdt
